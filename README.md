...
# Cyclone V DE1-SoC (5CSEMA5F31C6N)
...
Os próximos passos serão detalhados na próxima seção, [Execução e Testes](execucao-e-testes).
...
```
> **💡Nota**: Este caso foi testado para a imagem inicializada no Co-Processador.
